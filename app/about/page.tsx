      ...
      <div className="container-beef pb-24">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="card-beef mb-8">
            ...
            <div className="flex flex-col gap-6">
              <Step
                ...
                body="Start a Beef by writing your take and setting your stake — anywhere from $5 to $500. Your claim goes live as an open challenge."
              />
              <Step
                n="02"
                title="SOMEONE ACCEPTS"
                body="Any signed-in user can accept your challenge by matching your stake. The pot doubles. The debate clock starts."
              />
              <Step
                n="03"
                title="MAKE YOUR CASE"
                body="Both sides exchange arguments in a structured thread. This is your chance to back up what you said. Say it clearly. Say it well."
              />
              <Step
                n="04"
                title="THE AI PANEL JUDGES"
                body="When time runs out, a randomised panel of AI judges independently evaluates both sides — on logic, evidence, and persuasiveness. No favourites. No politics. Just the argument."
              />
              <Step
                n="05"
                title="WINNER TAKES THE POT"
                body="The panel's verdict is final. The winner receives the full pot minus a small platform fee. Funds hit your Beef balance instantly."
              />
            </div>
          </div>
          ...
          <div className="card-beef mb-8">
            ...
            <p className="text-beef-text-muted text-sm leading-relaxed mb-4">
              Judges assess each argument on three dimensions:
            </p>
          ...
          <div className="mb-12">
            ...
            <FAQ
              ...
              a="Yes. When you sign up, you can choose an anonymous handle. Your real identity is never shown on the platform. You can also set individual Beefs to anonymous mode."
            />
            <FAQ
              q="What happens if no one accepts my challenge?"
              a="Your challenge stays open until someone accepts or you cancel it. Your stake is only locked once both sides are in."
            />
            <FAQ
              q="Can I raise the stakes mid-debate?"
              a="Yes. Either participant can propose a raise during a live Beef. Both sides must agree for the new stake to take effect."
            />
            <FAQ
              q="What if the debate ends in a draw?"
              a="In the rare event the AI panel cannot determine a clear winner, both sides are refunded their full stake."
            />
            <FAQ
              q="Who can see my Beef?"
              a="All Beefs are public by default. The argument thread is visible to any visitor. Only the participants can post to it."
            />
            <FAQ
              q="Is there a minimum stake?"
              a="The minimum stake is $5. The maximum is $500 per side per Beef, keeping things competitive without being reckless."
            />
          </div>
