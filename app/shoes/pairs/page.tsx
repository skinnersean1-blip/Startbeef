      ...
      <header className="bg-shoe-bg-deep border-b border-shoe-border">
        <div className="container-shoe py-5 flex items-center justify-between">
          ...
          <div className="text-right">
            <h1 className="text-2xl font-bold text-shoe-cream tracking-tight">PAIRS</h1>
          ...
          <div className="flex items-center gap-6 flex-wrap">
            ...
            {[
              ...
              return (
                <Link
                  key={t.key}
                  href={isActive ? shoePath("/pairs") : `${shoePath("/pairs")}?condition=${t.key}`}
            ...
            {condition && (
              <Link href={shoePath("/pairs")} className="text-xs text-shoe-cream-dim hover:text-shoe-accent transition-colors ml-1">
                ✕ clear
              </Link>
            )}
      ...
      <main className="container-shoe py-8">
        {listings.length === 0 ? (
          <div className="py-20 text-center">
            <p className="text-shoe-cream-dim text-sm tracking-widest">NO PAIRS LISTED YET</p>
